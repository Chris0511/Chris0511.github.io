...
<body>
    ...
    <div class="form-card">
        <form action="tampil.php" method="post" id="form">  
            ...
            <p>
                ...
                <textarea name="bahan" id="bahan" rows="4" cols="50"></textarea>
            </p>

            <p>
                <label for="langkah">Langkah-langkah :</label>
                <textarea name="langkah" id="langkah" rows="4" cols="50"></textarea>
            </p>
            ...
            <p>
                ...
                <input type="date" name="tanggal_upload"><br>
            </p>
